        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="currencyCode" label="Currency Code"></el-table-column>
                    <el-table-column align="left" prop="amount" label="Amount"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_CURRENCY_KURS,
            paginate: getter.GET_PAGINATE_CURRENCY_KURS,
            total: getter.GET_CURRENCY_KURS_TOTAL
        }),
        paginator() {
    ...
    methods: {
        ...
        Create() {
            ...
            this.$router.replace('/new-currency-kurs');
        },
        ...
        Edit(e) {
            this.$store.commit(mutation.SET_CURRENCY_KURS_DETAIL, e);
            this.$router.replace('/edit-currency-kurs/' + e.id)
        },
        Detail(e) {
        ...
        Delete(e) {
            Swal.fire({
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_CURRENCY_KURS, e);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_CURRENCY_KURS, this.payload);
