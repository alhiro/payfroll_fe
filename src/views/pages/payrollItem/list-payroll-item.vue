        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="name" label="Name"></el-table-column>
                    <el-table-column align="left" prop="taxMode" label="Tax Mode" width="100"></el-table-column>
                    <el-table-column align="left" prop="allEmp" label="All Employee"></el-table-column>
                    <el-table-column align="left" prop="wageBpjsTk" label="Wage BPJS TK"></el-table-column>
                    <el-table-column align="left" prop="wageBpjsKes" label="All Employee"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_PAYROLL_ITEM,
            paginate: getter.GET_PAGINATE_PAYROLL_ITEM,
            total: getter.GET_PAYROLL_ITEM_TOTAL
        }),
        paginator() {
    ...
    methods: {
        handlePageChange(page) {
            ...
            this.$store.dispatch(action.LIST_TEAM, {
                page: page,
            });
        },
        Create() {
        ...
        Edit(e) {
            this.$store.commit(mutation.SET_PAYROLL_ITEM_DETAIL, e);
            this.$router.replace('/edit-payroll-item/' + e.id)
        },
        Detail(e) {
            this.$store.dispatch(action.TEAM_DETAIL, e.id);
        },
        Delete(e) {
            Swal.fire({
                title: "Are you sure?",
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_PAYROLL_ITEM, e.id);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_PAYROLL_ITEM, this.payload);
