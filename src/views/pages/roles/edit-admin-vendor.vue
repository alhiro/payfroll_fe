  ...
  <div class="page-table scrollable only-y" id="affix-container">
    <div class="card-base card-shadow--medium bg-white">
      <el-form ref="form" :rules="rules" :model="form">
          <el-row :gutter="20">
                <el-col :lg="8">
                    <el-form-item label="Holding ID" prop="holdingId">
                        <el-input placeholder="Input Holding ID" v-model="form.holdingId"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8">
                 ...
                 <el-col :lg="8">
                    <el-form-item label="Company ID" prop="companyId">
                        <el-input v-on:keypress.native="isNumber" placeholder="Input Company ID" v-model="form.companyId"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8">
                    <el-form-item label="Company Name" prop="comName">
                        <el-input placeholder="Input Company Name" v-model="form.comName"></el-input>
                    </el-form-item>
                </el-col>
                 <el-col :lg="8">
                    <el-form-item label="Role Description" prop="roleDesc">
                        <el-input placeholder="Input Role Description" v-model="form.roleDesc"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8">
                    <el-form-item label="Role Title" prop="roleTitle">
                        <el-input placeholder="Input Role Title" v-model="form.roleTitle"></el-input>
                    </el-form-item>
                </el-col>
                 <el-col :lg="8">
                    <el-form-item label="Role Access" prop="roleAccess">
                        <el-input v-on:keypress.native="isNumber" placeholder="Role Access" v-model="form.roleAccess"></el-input>
                    </el-form-item>
                </el-col>
                 <el-col :lg="8">
                    <el-form-item label="Role Type" prop="roleType">
                        <el-input v-on:keypress.native="isNumber" placeholder="Role Type" v-model="form.roleType"></el-input>
                    </el-form-item>
                </el-col>
            </el-row> 
      </el-form>
