        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="type" label="Type"></el-table-column>
                    <el-table-column align="left" prop="email" label="Email"></el-table-column>
                    <el-table-column align="left" prop="address" label="Address"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            listData: getter.GET_LIST_CONSULTANT,
            paginate: getter.GET_PAGINATE_CONSULTANT,
            total: getter.GET_CONSULTANT_TOTAL,
        }),
        paginator() {
    ...
    methods: {
        ...
        Edit(e) {
            // console.log(e)
            e.gotoEdit = true;
            this.$store.dispatch(action.DETAIL_CONSULTANT, e);
        },
        Delete(e) {
            Swal.fire({
                title: "Are you sure?",
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_CONSULTANT, e.id);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_CONSULTANT, this.payload);
