...
export default {
        ...
        onSubmit(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.UPDATE_COMPANY, this.form);
                } else {
                    return false;
                }
            });
    ...
    created() {
        this.form.name = this.content.name,
            ...
            this.form.province = this.content.province,
            ...
            this.form.dbName = this.content.dbName,
            this.form.holdingId = parseInt(this.content.holdingId)
    }
};
</script>
