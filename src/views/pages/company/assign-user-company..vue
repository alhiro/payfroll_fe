...
<div class="page-table scrollable only-y" id="affix-container">
    <div class="card-base card-shadow--medium bg-white">
        <el-row :gutter="10">
            <el-col :span="6">
                <el-button @click="Create()" style="width: 100%; background: #04b3bf; border: 0px;"><b style="color: #ffffff">Assign Users</b></el-button>
            </el-col>
...
export default {
    ...
    methods: {
        ...
        Delete(e) {
            Swal.fire({
                title: "Are you sure?",
                text: "Do you want to unassigne this user from the company!",
                type: "warning",
