    ...
    <div class="card-base card-shadow--medium bg-white">
        ...
        <el-form ref="form" :rules="rules" :model="form">
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="Menu Type Id" prop="menuType">
...
export default {
    ...
    data() {
        return {
            ...
            menuIcons: [
                {value: 'mdi-account-settings-variant', name: 'mdi-account-settings-variant'},
                {value: 'mdi-account-network', name: 'mdi-account-network'},
                {value: 'mdi-account-multiple', name: 'mdi-account-multiple'},
                {value: 'mdi-cash', name: 'mdi-cash'},
                {value: 'mdi-chart-areaspline', name: 'mdi-chart-areaspline'},
                {value: 'mdi mdi-package-variant', name: 'mdi mdi-package-variant'},
            ],    
            select: [{
                    idrole: 2,
                    name: "Vendor"
        ...
        onSubmit(formName) {
            ...
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.CREATE_MENU, this.form);
                } else {
                    return false;
                }
            });
