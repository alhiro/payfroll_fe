...
export default {
        ...
        onSubmit(formName) {
            ...
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.UPDATE_ENTITY, this.form);
                } else {
                    return false;
                }
            });
    ...
    created() {
        if(this.content.bpjsDtpStart)
            this.content.bpjsDtpStart = moment(this.content.bpjsDtpStart, 'DD-MM-YYYY HH:ii:ss').format('YYYY-MM-DD');
        this.form.name = this.content.name,
        this.form.npwp = this.content.npwp,
        this.form.phone = this.content.phone,
        this.form.email = this.content.email,
        this.form.dirName = this.content.dirName,
        this.form.dirNpwp = this.content.dirNpwp,
        this.form.city = this.content.city,
        this.form.zipcode = this.content.zipCode,
        this.form.id = this.content.id,
        this.form.fax = this.content.faxNo,
        this.form.bpjstk = this.content.bpjsTkNpp,
        this.form.bpjsks = this.content.bpjsKesNpp,
        this.form.note = this.content.remark,
        this.form.klu = this.content.klu,
        this.form.dtp_start = this.content.bpjsDtpStart;
    },
    mounted() {
