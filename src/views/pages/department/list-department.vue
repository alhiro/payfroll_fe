        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="depName" label="Department Name"></el-table-column>
                    <el-table-column align="left" prop="depCode" label="Department Code"></el-table-column>
                    <el-table-column align="left" prop="depOrder" label="Department Order"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_DEPARTMENT,
            paginate: getter.GET_PAGINATE_DEPARTMENT,
            total: getter.GET_DEPARTMENT_TOTAL
        }),
        paginator() {
    ...
    methods: {
        handlePageChange(page) {
            ...
            this.$store.dispatch(action.LIST_DEPARTMENT, {
                page: page,
            });
        },
        Create() {
            this.$store.dispatch(action.SELECT_COMPANY)
            this.$store.dispatch(action.SELECT_ENTITY)
            this.$store.dispatch(action.SELECT_DEPARTMENT)
            this.$store.dispatch(action.SELECT_LEVEL)
        ...
        Edit(e) {
            ...
            this.$store.dispatch(action.SELECT_DEPARTMENT)
            this.$store.dispatch(action.SELECT_LEVEL)
            this.$store.dispatch(action.DETAIL_DEPARTMENT, e.id);
        },
        Detail(e) {
            this.$store.dispatch(action.DEPARTMENT_DETAIL, e.id);
        },
        Delete(e) {
            Swal.fire({
                title: "Are you sure?",
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_DEPARTMENT, e.id);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_DEPARTMENT, this.payload);
