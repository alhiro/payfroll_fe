...
export default {
        ...
        onSubmit(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.UPDATE_DEPARTMENT, this.form);
                } else {
                    return false;
                }
            });
    ...
    computed: {
        ...mapGetters({
            ...
            content: getter.GET_DEPARTMENT_DETAIL
        }),

    },
    created() {
        this.form.entitiesId = this.content.entitiesId
        if (this.content.deptParentId) {
            this.form.deptParentId = parseInt(this.content.deptParentId)
        }
        this.form.depLevel = this.content.depLevel
        this.form.id = this.content.id
        this.form.comId = this.content.comId
        this.form.depName = this.content.depName
        this.form.depOrder = this.content.depOrder
        this.form.depCode = this.content.depCode
    }
};
</script>
