            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="Bank Name" prop="name">
                        <el-input placeholder="Input Bank Name" v-model="form.name"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="Address" prop="address">
                        <el-input placeholder="Input Address" v-model="form.address"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="Branch" prop="branch">
                        <el-input placeholder="Input Branch" v-model="form.branch"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="Bank Code" prop="code">
                        <el-input placeholder="Input Bank Code" v-model="form.code"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="Code Location 1" prop="codeloc1">
                        <el-input placeholder="Input Code Location 1" v-model="form.codeloc1"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="Code Location 2" prop="codeloc2">
                        <el-input placeholder="Input Code Location 2" v-model="form.codeloc2"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item label="Swift Code" prop="swiftCode">
                        <el-input placeholder="Input Swift Code" v-model="form.swiftCode"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
...
export default {
        ...
        onSubmit(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.UPDATE_BANK, this.form);
                } else {
                    return false;
                }
            });
    ...
    computed: {
        ...mapGetters({
            ...
            content: getter.GET_BANK_DETAIL,
    ...
    created() {
        ...
        this.form.comId = this.content.comId
        this.form.name = this.content.name
        this.form.branch = this.content.branch
        this.form.codeloc1 = this.content.codeloc1
        this.form.codeloc2 = this.content.codeloc2
        this.form.address = this.content.address
        this.form.city = this.content.city
        this.form.code = this.content.code
        this.form.swiftCode = this.content.swiftCode
    }
};
</script>
