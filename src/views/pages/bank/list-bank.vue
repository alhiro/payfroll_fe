        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="name" label="Bank Name"></el-table-column>
                    <el-table-column align="left" prop="swiftCode" label="Swift Code"></el-table-column>
                    <el-table-column align="left" prop="branch" label="Branch"></el-table-column>
                     <el-table-column align="left" prop="city" label="City"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_BANK,
            paginate: getter.GET_PAGINATE_BANK,
            total: getter.GET_BANK_TOTAL
        }),
        paginator() {
    ...
    methods: {
        handlePageChange(page) {
            ...
            this.$store.dispatch(action.LIST_BANK, {
                page: page,
            });
        },
        Create() {
        ...
        Edit(e) {
            this.$store.dispatch(action.SELECT_COMPANY)
            this.$store.dispatch(action.DETAIL_BANK, e.id);
        },
        Detail(e) {
        ...
        Delete(e) {
            Swal.fire({
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_BANK, e.id);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_BANK, this.payload);
