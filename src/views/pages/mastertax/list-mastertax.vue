        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="center" prop="taxCode" label="Tax Code"></el-table-column>
                    <el-table-column align="center" prop="taxGroup" label="Tax Group"></el-table-column>
                    <el-table-column align="center" prop="taxType" label="Tax Type"></el-table-column>
                    <el-table-column align="center" prop="taxDesc" label="Tax Description"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_MASTERTAX,
            paginate: getter.GET_PAGINATE_MASTERTAX,
            total: getter.GET_MASTERTAX_TOTAL
        }),
        paginator() {
    ...
    methods: {
        handlePageChange(page) {
            ...
            this.$store.dispatch(action.LIST_MASTERTAX, {
                page: page,
            });
        },
        Create() {
        ...
        Edit(e) {
            this.$store.dispatch(action.DETAIL_MASTERTAX, e.id);
        },
        Delete(e) {
            Swal.fire({
                title: "Are you sure?",
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_MASTERTAX, e.id);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_MASTERTAX, this.payload);
