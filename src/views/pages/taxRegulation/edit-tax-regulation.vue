            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="Admin Username" prop="userName">
                        <el-input disabled placeholder="Input Username" v-model="form.userName"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
...
export default {
    ...
    created() {
        ...
        this.form.holdingType = this.content.holding_type,
            ...
            this.form.holdingPhone = this.content.holding_phone,
            ...
            this.form.province = this.content.holding_province,
            this.form.notes = this.content.holding_notes,
