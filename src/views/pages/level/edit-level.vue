            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="Level Code" prop="levCode">
                        <el-input placeholder="Input Level Name" v-model="form.levCode"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
...
export default {
        ...
        onSubmit(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.UPDATE_LEVEL, this.form);
                } else {
                    return false;
                }
            });
    ...
    computed: {
        ...mapGetters({
            ...
            content: getter.GET_LEVEL_DETAIL,
    ...
    created() {
        this.form.id = this.content.level_id
        this.form.comId = this.content.com_Id
        this.form.levName = this.content.lev_name
        this.form.levOrder = this.content.lev_order
        this.form.levCode = this.content.lev_code
    }
};
</script>
