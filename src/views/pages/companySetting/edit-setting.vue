...
<!--                </el-col>-->
                <el-col :span="12">
                    <el-form-item label="Status" prop="status">
                        <el-input placeholder="Input Level Order" v-on:keypress.native="isNumber" maxlength="2" v-model="form.status"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="Year" prop="year">
                        <el-input placeholder="Input Level Order" v-on:keypress.native="isNumber" maxlength="4" v-model="form.year"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
...
export default {
        ...
        onSubmit(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.UPDATE_COMPANY_SETTING, this.form);
                } else {
                    return false;
                }
            });
    ...
    computed: {
        ...mapGetters({
            ...
            content: getter.GET_COMPANY_SETTING_DETAIL,
    ...
    created() {
        ...
        this.form.status    = this.content.status;
