        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="year" label="Year"></el-table-column>
                    <el-table-column align="left" prop="status" label="Status"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_COMPANY_SETTING,
            paginate: getter.GET_PAGINATE_COMPANY_SETTING,
            total: getter.GET_COMPANY_SETTING_TOTAL
        }),
        paginator() {
    ...
    methods: {
        ...
        Edit(e) {
            this.$store.dispatch(action.SELECT_COMPANY)
            this.$store.commit(mutation.SET_COMPANY_SETTING_DETAIL, e);
            this.$router.replace('/edit-company-setting/' + e.id)
        },
        Detail(e) {
        ...
        Delete(e) {
            Swal.fire({
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_COMPANY_SETTING, e);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_COMPANY_SETTING, this.payload);
