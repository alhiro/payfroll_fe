    ...
    <div class="card-base card-shadow--medium bg-white">
        ...
        <el-form ref="form" :rules="rules" :model="form">
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="Grade Name" prop="graName">
                        <el-input placeholder="Input Grade Name" v-model="form.graName"></el-input>
                    </el-form-item>
                </el-col>
                 <el-col :span="12">
                    <el-form-item label="Grade Code" prop="graCode">
                        <el-input placeholder="Input Grade Name" v-model="form.graCode"></el-input>
                    </el-form-item>
                </el-col>
                 <el-col :span="12">
                    <el-form-item label="Grade Order" prop="graOrder">
                        <el-input placeholder="Input Grade Order" v-on:keypress.native="isNumber" v-model="form.graOrder"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
...
export default {
        ...
        return {
            ...
            rules: {
                ...
                graName: [{
                 ...
                 graOrder: [{
                    required: true,
                    message: "Grade Order is required!",
                    trigger: "blur"
                }],
                 graCode: [{
                    required: true,
        ...
        onSubmit(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.$store.dispatch(action.UPDATE_GRADE, this.form);
                } else {
                    return false;
                }
            });
    ...
    computed: {
        ...mapGetters({
            ...
            content: getter.GET_GRADE_DETAIL,
    ...
    created(){
        ...
        this.form.graName = this.content.graName
         this.form.graOrder = this.content.graOrder
          this.form.graCode = this.content.graCode
    }
};
</script>
