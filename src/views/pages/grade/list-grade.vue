        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="graName" label="Grade Name"></el-table-column>
                    <el-table-column align="left" prop="graCode" label="Grade Code"></el-table-column>
                    <el-table-column align="left" prop="graOrder" label="Grade Order"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_GRADE,
            paginate: getter.GET_PAGINATE_GRADE,
            total: getter.GET_GRADE_TOTAL
        }),
        paginator() {
    ...
    methods: {
        handlePageChange(page) {
            ...
            this.$store.dispatch(action.LIST_GRADE, {
                page: page,
            });
        },
        Create() {
        ...
        Edit(e) {
            this.$store.dispatch(action.SELECT_COMPANY)
            this.$store.dispatch(action.DETAIL_GRADE, e.id);
        },
        Detail(e) {
            this.$store.dispatch(action.GRADE_DETAIL, e.id);
        },
        Delete(e) {
            Swal.fire({
                title: "Are you sure?",
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_GRADE, e.id);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_GRADE, this.payload);
