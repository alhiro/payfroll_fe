        ...
        <el-row :gutter="10">
            <el-col :span="24">
                <el-table :default-sort="{prop: 'id', order: 'ascending'}" :data="listData" style="width: 100%">
                    ...
                    <el-table-column align="left" prop="tem_name" label="Team Name"></el-table-column>
                    <el-table-column align="left" prop="tem_saturday" label="Saturday"></el-table-column>
                    <el-table-column align="left" prop="tem_sunday" label="Sunday"></el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            listData: getter.GET_LIST_TEAM,
            paginate: getter.GET_PAGINATE_TEAM,
            total: getter.GET_TEAM_TOTAL
        }),
        paginator() {
    ...
    methods: {
        ...
        Edit(e) {
            this.$store.dispatch(action.SELECT_COMPANY)
            this.$store.dispatch(action.DETAIL_TEAM, e.id);
        },
        Detail(e) {
        ...
        Delete(e) {
            Swal.fire({
                ...
                if (result.value) {
                    this.$store.dispatch(action.DELETE_TEAM, e.id);
                }
            });
        }
    },
    async mounted() {
        await this.$store.dispatch(action.LIST_TEAM, this.payload);
